...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5">
                    <div class="left-side">
                        <div class="logo">
                            <img src="public/img/logo.png" alt="Flight Template">
                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        ...
                                                        <div class="weather-icon">
                                                            <img src="public/img/weather-icon-03.png" alt="">
                                                        </div>
                                                        <span>32&deg;C</span>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>Thailand</h6>
                                                        <div class="weather-icon">
                                                            <img src="public/img/weather-icon-02.png" alt="">
                                                        </div>
                                                        <span>28&deg;C</span>
                                                        <ul class="time-weather">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="weather-item">
                                                        <h6>India</h6>
                                                        <div class="weather-icon">
                                                            <img src="public/img/weather-icon-01.png" alt="">
                                                        </div>
                                                        <span>33&deg;C</span>
                                                        <ul class="time-weather">
                                                            <li>6AM <span>26&deg;</span></li>
                    ...
                    <div class="col-md-8">
                        <section id="third-tab-group" class="recommendedgroup">
                            <div id="livingroom">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div id="owl-livingroom" class="owl-carousel owl-theme">
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="public/img/suite-02.jpg" alt="">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="public/img/suite-01.jpg" alt="">
                                                    <div class="text-content">
                                            ...
                                            <div class="item">
                                                <div class="suiteroom-item">
                                                    <img src="public/img/suite-03.jpg" alt="">
                                                    <div class="text-content">
                            ...
                            <div id="swimingpool">
                                <img src="public/img/swiming-pool.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="massage">
                                <img src="public/img/massage-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="fitness">
                                <img src="public/img/fitness-service.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                            ...
                            <div id="event">
                                <img src="public/img/evening-event.jpg" alt="">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="text-content">
                    ...
                    <div id="owl-mostvisited" class="owl-carousel owl-theme">
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="public/img/place-01.jpg" alt="">
                                <div class="text-content">
                                    <h4>River Views</h4>
                                    <span>New York</span>
                                </div>
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="public/img/place-02.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="public/img/place-03.jpg" alt="">
                                <div class="text-content">
                        ...
                        <div class="item col-md-12">
                            <div class="visited-item">
                                <img src="public/img/place-04.jpg" alt="">
                                <div class="text-content">
    ...
    <script src="public///ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
    ...
    <script src="public/http://ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js" type="text/javascript"></script>
